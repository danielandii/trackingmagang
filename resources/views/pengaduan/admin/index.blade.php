											...
											<div class="list-icons">
												<div class="dropdown">
													...
													<div class="dropdown-menu dropdown-menu-right">
														<a href="{{ route('admin.home-pengaduan.detail', $pengaduan->id)}}" class="dropdown-item"><i class="fas fa-clipboard"></i> tanggapi</a>
														<a class="dropdown-item delbutton" data-toggle="modal" data-target="#modal_theme_danger" data-uri="{{ route('admin.home-pengaduan.destroy',$pengaduan->id ) }}"><i class="icon-x"></i> Delete</a>
													</div>
												</div>
											</div>
