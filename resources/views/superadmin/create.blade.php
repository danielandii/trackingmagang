...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i>Tambah Super Admin</h4>
	...
	<div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form id="submituser" class="form-validate-jquery" action="{{ route('super-admin.store')}}" method="post">
					@csrf
					<fieldset class="mb-3">
						<legend class="text-uppercase font-size-sm font-weight-bold">Data Super Admin</legend>
					...
					<div class="text-right">
						<a href="{{ url('/superadmin')}}" class="btn btn-light">Kembali <i class="icon-undo"></i></a>
